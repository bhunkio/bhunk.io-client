# This is taken and modified from https://github.com/bfirsh/stable-diffusion.git
...
from scripts.img2img_helper import ImgToImgRequest
...
def main():
    ...
    default_request = ImgToImgRequest()

    parser.add_argument(
        "--prompt",
        type=str,
        nargs="?",
        default=default_request.prompt,
    ...
    parser.add_argument(
        ...
        default=default_request.outdir
    )
    ...
    print(ImgToImgRequest(*opt))
    exit(1)
    img_to_img(ImgToImgRequest(*opt))
...
def img_to_img(opt: PrecisionType):
